        ...
        <OptionCard showOptions={this.props.showOptions}>
          <Option showOptions={this.props.showOptions}>
            ...
            <p>
              ...
              email which describe ethnicity, religion or gender of a person until the shortlisting so that
              everybody gets equal chance based entirely on skills.
            </p>
          ...
          <Option showOptions={this.props.showOptions}>
            <h1>Feature 2</h1>
            <p>
              To give an inclusive idea about the organization's opportunities we help check job descriptions 
              and advertisements for dominating gender specific words and review along with suggesting user 
